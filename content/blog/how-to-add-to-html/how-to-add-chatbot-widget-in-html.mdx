...
<Image alt="Chatbuild Io Home Page Image" width={500} height={400} className="w-full" src="/static/chatbuild_home.webp"/>
...
<Image width={500} height={400} className="w-full" alt="Script Image" src="/static/script.webp"/>
