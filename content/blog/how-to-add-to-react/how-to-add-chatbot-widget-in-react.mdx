...
<Image alt="Chatbuild Home Image" width={500} height={400} className="w-full" src="/static/chatbuild_home.webp"/>
...
<Image width={500} height={400} alt="Script Image" className="w-full" src="/static/script.webp"/>
